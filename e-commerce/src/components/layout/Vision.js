function Vision({ data }) {
  return (
    <div className="Vision py-[5rem] w-[80%] mx-auto flex sm:flex-col-reverse">
      <div className="images flex gap-4">
        <img src={data.img1} />
        <img src={data.img2} />
      </div>
      <div className="text-content w-1/2 flex flex-col justify-center gap-4 pl-[5.6rem] sm:p-0 sm:w-fit">
